...
My previous test that demonstrated this approach was written completely by hand. This one was created completely by a LLM with no human in the loop - except for prompting and compiling results into this repository, but I believe it can be automatized too.
